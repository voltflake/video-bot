import { type FileData, type Message, MessageFlags } from 'disgroove';
...
export class Job {
    ...
    extractors: ((url: URL) => Promise<Item[]>)[] = [];
    ...
    async tryToSendContent(items: Item[]): Promise<void> {
        sendGallery(items, this);
    }
